...
foreach ($sidebar_id as $sidebar) {
	/*Comprobamos si el sidebar está activado para entradas*/
	if (isset($sidebar_config[$sidebar.'-page-post']) && ($sidebar_config[$sidebar.'-page-post'] == 'post')) {
...
?>
<?php
/*Loop Wordpress para pintar la entrada actual*/
while ( have_posts() ) : the_post();
	...
	/*Pintamos el cuerpo de la entrada*/
	?>
	<section id="main" class="page page-<?php echo $post->post_name; /*clase con slug de la entrada para individualidades css*/?>">
		<div class="wrapper-box">			
				...
				<div class="content">
					...
					<a class="edit" href="<?php echo get_edit_post_link(); ?>">Editar entrada</a>		
				</div>				
		</div>
	</section>
	<?php
